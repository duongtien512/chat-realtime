...
let removeRequestContactSent = (currentUserId, contactId) => {
    return new Promise(async (resolve, reject) => {
        ...
        await NotificationModel.model.removeRequestContactSentNotification(currentUserId, contactId, notifyTypeAddContact);
        resolve(true);
    });
}
...
let removeRequestContactReceived = (currentUserId, contactId) => {
    return new Promise(async (resolve, reject) => {
        ...
        // remove notification
        // let notifyTypeAddContact = NotificationModel.types.ADD_CONTACT
        // await NotificationModel.model.removeRequestContactReceivedNotification(currentUserId, contactId, notifyTypeAddContact);
        resolve(true);
    });
}
